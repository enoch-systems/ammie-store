              ...
              {items.map((item) => (
                <div key={item.id} className="flex gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-muted-foreground mb-3 text-sm">Premium quality hair product</p>
                     ...
                     <div className="flex items-center gap-2 sm:gap-3">
                       <div className="flex items-center border border-border rounded-full">
                         <button
                           ...
                           className="p-1.5 sm:p-1.5 hover:bg-muted boty-transition rounded-l-full"
                         ...
                         <button
                           type="button"
                           onClick={() => updateQuantity(item.id, item.quantity + 1)}
                           className="p-1.5 sm:p-1.5 hover:bg-muted boty-transition rounded-r-full"
                       ...
                       <button
                         ...
                         className="p-2 sm:p-1.5 text-muted-foreground hover:text-destructive hover:bg-destructive/10 boty-transition rounded-full sm:rounded-none"
